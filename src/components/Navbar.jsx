  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 fixed ${
        isRegisteration ? '' : 'top-0'
      } z-20 ${scrolled ? 'bg-primary' : 'bg-transparent'} navbar`}
    >
              ...
              <button
                className={`${
                  location.pathname.includes('competitions')
                    ? 'text-white'
                    : 'text-secondary'
                } dropbtn hover:text-white pt-[2px] text-[18px] font-medium cursor-pointer`}
              >
                Competitions
              </button>
              <div className='dropdown-content '>
                <Link
                  className='links hover:text-white bg-[#915EFF]'
                  to='/competitions/web'
                >
                  Web Hackathon
                </Link>
                ...
                <Link
                  className='links hover:text-white bg-[#915EFF]'
                  to='/competitions/fifa'
                >
                  Esports FIFA
                </Link>
                <Link
                  className='links hover:text-white bg-[#915EFF]'
                  to='/competitions/tekken'
                >
                  Esports TEKKEN
                </Link>
              </div>
